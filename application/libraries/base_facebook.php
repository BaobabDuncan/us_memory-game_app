...
abstract class BaseFacebook
{
  ...
  //Bond
  public function getUserLoginUrl($params=array()) {
    $this->establishCSRFTokenState();
    //Bond  
	
    $currentUrl = $this->getCurrentUrl();
    //$currentUrl = 'https://apps.facebook.com/memory__game/';
    //$currentUrl = 'http://www.facebook.com/pages/Bond/138140982929477?sk=app_220844064602301';    
    return $this->getUrl(
      'www',
      'dialog/oauth',
      array_merge(array(
                    'client_id' => $this->getAppId(),
                    'redirect_uri' => 'mhrbond', // possibly overwritten
      				'scope' => 'user_photos,publish_stream',      
                    'state' => $this->state),
                  $params));
  }
  public function getAdminLoginUrl($params=array()) {
    $this->establishCSRFTokenState();
    //Bond
    //$currentUrl = $this->getCurrentUrl();
    $currentUrl = 'https://apps.facebook.com/memory__game/';
