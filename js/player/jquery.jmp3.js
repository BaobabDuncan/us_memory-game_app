//http://mobileworks.co.kr/facebook/app/
...
jQuery.fn.jmp3 = function(passedOptions){
	// hard-wired options
	var playerpath = "http://mobileworks.co.kr/facebook/app/memory_game/js/player/";					// SET THIS FIRST: path to singlemp3player.swf
	
	// passable options
	var options = {
		"filename": "",
		"filepath": "http://mobileworks.co.kr/facebook/app/memory_game/midia/",										// path to MP3 file (default: current directory)
